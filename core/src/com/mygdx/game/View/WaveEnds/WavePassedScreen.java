...
public class WavePassedScreen implements Screen {
    ...
    public WavePassedScreen (MaosVengeance game){
        this.game = game;
    ...
    public void show() {
        ...
        stage.addActor(WavePassedController.wavePassedController.table);
    }
    ...
    public void render(float v) {
        ...
        stage.draw();
        WavePassedController.wavePassedController.handleMainMenuButtons(game);
    }
