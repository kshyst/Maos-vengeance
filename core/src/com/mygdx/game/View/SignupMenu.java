...
public class SignupMenu implements Screen {
    ...
    public SignupMenu (MaosVengeance game){
        this.game = game;
    ...
    public void show() {
        ...
        stage.addActor(SignupMenuController.signupMenuController.table);
    }
    ...
    public void render(float v) {
        ...
        stage.draw();
        SignupMenuController.signupMenuController.handleMainMenuButtons(game);
    }
