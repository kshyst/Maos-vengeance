...
public class ProfileMenu implements Screen {
    ...
    public ProfileMenu (MaosVengeance game){
        this.game = game;
    ...
    public void show() {
        ...
        stage.addActor(ProfileMenuController.profileMenuController.table);
    }
    ...
    public void render(float v) {
        ...
        stage.draw();
        ProfileMenuController.profileMenuController.handleMainMenuButtons(game);
    }
