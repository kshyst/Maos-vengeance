...
public class GameCompeleteController {
    public static GameCompeleteController gameCompeleteController = new GameCompeleteController();
    private final Skin skin = new Skin(Gdx.files.internal(GameAssetsManager.gameAssetsManager.uiSkin));
    private final Label wavePassed = new Label("Mao's legacy has been restored!", skin, "title");
    ...
    private GameCompeleteController() {
