...
public class ClusterCollectible extends Collectibles {
    public Sprite sprite = new Sprite(GameAssetsManager.gameAssetsManager.clusterCollectibleTexture);
    public Texture texture = GameAssetsManager.gameAssetsManager.clusterCollectibleTexture;
    public ClusterCollectible(float x, float y) {
        this.x = x;
        this.y = y;
        this.speed = 200;
